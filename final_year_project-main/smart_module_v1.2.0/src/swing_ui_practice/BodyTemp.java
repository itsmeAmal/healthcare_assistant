 ...
 * @author Rashmi
 */
public class BodyTemp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(623, 729));
        setMinimumSize(new java.awt.Dimension(623, 729));
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(623, 729));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BodyTemp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
